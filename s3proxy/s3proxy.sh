...
# Work around HTTP 404 returned for PUT requests. See https://gitlab.pep.cs.ru.nl/pep/core/-/issues/2620#note_48061
# TODO: clear S3PROXY_IMAGE_TAG variable when problem is fixed. See https://github.com/gaul/s3proxy/issues/813
S3PROXY_IMAGE_TAG="sha-ce80406"
