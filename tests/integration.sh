...
usage() {
  ...
  echo
  echo "Options are:"
  echo " --image <IMAGE>              - The pep-services docker image to use. Default: $IMAGE_REPOSITORY:<your-commit-sha> , which currently evaluates to $(default_image)"
  ...
  echo "                              - Subset of tests to skip, separated by spaces, see --tests-to-run. Default none"
