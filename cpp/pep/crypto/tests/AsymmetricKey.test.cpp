...
std::vector<unsigned char> inputPublicKeyDerVector= {
...
std::string inputPublicKeyDER(reinterpret_cast<char const*>(inputPublicKeyDerVector.data()), inputPublicKeyDerVector.size());
...
std::vector<unsigned char> inputPrivateKeyDerVector= {
...
std::string inputPrivateKeyDER(reinterpret_cast<char const*>(inputPrivateKeyDerVector.data()), inputPrivateKeyDerVector.size());
