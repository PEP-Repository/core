...
CPURBG::CPURBG()
  ...
  if (1 != EVP_EncryptInit_ex(
        ...
        EVP_aes_256_cbc(),
        nullptr,
        reinterpret_cast<uint8_t*>(&seed[0]),
        reinterpret_cast<uint8_t*>(&seed[32])))
...
void CPURBG::fillBuffer() {
  ...
  if (1 != EVP_EncryptUpdate(
        mCtx.get(),
        reinterpret_cast<uint8_t*>(&mBuffer[0]),
        &len,
        reinterpret_cast<const uint8_t*>(&plaintext[0]),
        bufferSize*8))
...
CPRNG::CPRNG()
  ...
  if (1 != EVP_EncryptInit_ex(
        ...
        EVP_aes_256_cbc(),
        nullptr,
        reinterpret_cast<const uint8_t*>(&seed[0]),
        reinterpret_cast<const uint8_t*>(&seed[32])))
