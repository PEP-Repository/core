...
public:
  typedef typename ProtocolBufferedSerialization<Signed<T> >::ProtocolBufferType SignedProtocolBufferType;
  typedef typename ProtocolBufferedSerialization<T>::ProtocolBufferType UnsignedProtocolBufferType;
...
public:
  typedef typename ProtocolBufferedSerialization<Encrypted<T> >::ProtocolBufferType EncryptedProtocolBufferType;
  typedef typename ProtocolBufferedSerialization<T>::ProtocolBufferType UnsignedProtocolBufferType;
