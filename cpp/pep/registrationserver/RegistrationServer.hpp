...
private:
  MessageBatches handleSignedPEPIdRegistrationRequest(std::shared_ptr<SignedPEPIdRegistrationRequest> lpRequest);
  MessageBatches handleSignedRegistrationRequest(std::shared_ptr<SignedRegistrationRequest> lpRequest);
  MessageBatches handleListCastorImportColumnsRequest(std::shared_ptr<ListCastorImportColumnsRequest> lpRequest);
