...
private:
  rxcpp::observable<rxcpp::observable<std::shared_ptr<std::string>>> handleSignedPEPIdRegistrationRequest(std::shared_ptr<SignedPEPIdRegistrationRequest> lpRequest);
  rxcpp::observable<rxcpp::observable<std::shared_ptr<std::string>>> handleSignedRegistrationRequest(std::shared_ptr<SignedRegistrationRequest> lpRequest);
  rxcpp::observable<rxcpp::observable<std::shared_ptr<std::string>>> handleListCastorImportColumnsRequest(std::shared_ptr<ListCastorImportColumnsRequest> lpRequest);
