 ...
 *
 * \param parent The QObject (QWidget in this case) from which this decends. Mainwindow will be the parent of everything and main.cpp passes nullptr for this value during construction.
 ...
 * \return none. When mainwindow closes the client will terminate.
 */
...
void MainWindow::showForToken(QString token) {
  ...
  pepClient->enrollUser(token.toStdString())
    ...
    .observe_on(observe_on_gui())
      ...
      auto user = QString::fromStdString(cert.getCommonName());
      auto role = QString::fromStdString(cert.getOrganizationalUnit());
 ...
 *
 * \param bool True if the user has an expired session. Default = false.
 * \return none.
 */
...
/*! \brief Brief description of what this code block does
 *
 * A more complete description of the code block can go here.
 *
 * \param arg1 The first argument which will be referenced as arg1 throughout the code block.
 * \param arg2 The second argument which will be referenced as arg2 throughout the code block.
 * ...
 * \return The return value of this code block and what it should be.
 */
