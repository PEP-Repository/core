...
typedef std::optional<std::string> ExportDataCell;
typedef std::vector<ExportDataCell> ExportDataRow;
typedef std::vector<ExportDataRow> ExportDataTable;
typedef std::vector<ExportDataTable>::const_iterator ExportDataTableIterator;

class ExportableItem : public std::enable_shared_from_this<ExportableItem> {
public:
  virtual inline ~ExportableItem() {}
