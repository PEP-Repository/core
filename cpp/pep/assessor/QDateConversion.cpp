#include <pep/assessor/QDateConversion.hpp>
...
//TODO can't this just be value.toSecsSinceEpoch()?
...
//TODO can't this just be QDateTime::fromSecsSinceEpoch(value)?
...
#else
   return QDateTime(date, time, Qt::LocalTime); // Deprecated
#endif
}
