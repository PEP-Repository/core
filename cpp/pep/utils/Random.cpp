...
/*! \brief  Random number generator callback for use with mbedtls.
 *
 *  Wrapper around RandomBytes.
 *
 *  \param p_rng Not used.
 *  \param [out] output The buffer to place the random bytes in.
