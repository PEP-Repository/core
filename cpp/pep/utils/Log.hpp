...
public:
  ...
  typedef boost::log::sources::severity_channel_logger_mt<severity_level, std::string> pep_severity_channel_logger;
...
public:
  SysLogging(severity_level minimum_level, const std::string& szHostname = "", unsigned short wPort = 514)
