...
private:
  ...
  SerializedResponse handleUserEnrollmentRequest(std::shared_ptr<EnrollmentRequest> enrollmentRequest);
  SerializedResponse handleTokenBlockingListRequest(std::shared_ptr<SignedTokenBlockingListRequest> signedRequest);
  SerializedResponse handleTokenBlockingCreateRequest(std::shared_ptr<SignedTokenBlockingCreateRequest> signedRequest);
  SerializedResponse handleTokenBlockingRemoveRequest(std::shared_ptr<SignedTokenBlockingRemoveRequest> signedRequest);
