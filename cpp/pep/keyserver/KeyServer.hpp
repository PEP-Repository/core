...
private:
  MessageBatches handleUserEnrollmentRequest(std::shared_ptr<EnrollmentRequest> enrollmentRequest);
  MessageBatches handleTokenBlockingListRequest(std::shared_ptr<SignedTokenBlockingListRequest> signedRequest);
  MessageBatches handleTokenBlockingCreateRequest(std::shared_ptr<SignedTokenBlockingCreateRequest> signedRequest);
  MessageBatches handleTokenBlockingRemoveRequest(std::shared_ptr<SignedTokenBlockingRemoveRequest> signedRequest);
