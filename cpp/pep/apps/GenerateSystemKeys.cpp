...
class GenerateSystemKeysApplication : public pep::Application {
  ...
  protected:
    ...
    int execute() override {
      ...
      CurvePoint masterPublicKeyPseudonymsPoint = CurvePoint::BaseMult(ts.pseudonyms * am.pseudonyms);
      CurvePoint masterPublicKeyDataPoint = CurvePoint::BaseMult(ts.data * am.data);
