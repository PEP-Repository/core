...
class TokenApplication : public pep::commandline::Utility {
  ...
  pep::commandline::Parameters getSupportedParameters() const override {
    ...
    return pep::commandline::Utility::getSupportedParameters()
      ...
      + pep::commandline::Parameter("group", "Specifies the \"group\" field of the token").value(pep::commandline::Value<std::string>().defaultsTo(pep::user_group::ResearchAssessor))
      + pep::commandline::Parameter("issued-at", "Specifies the \"iat\" field of the token").value(pep::commandline::Value<uint64_t>().defaultsTo(static_cast<uint64_t>(now), "now"))
      + pep::commandline::Parameter("expiration-time", "Specifies the \"exp\" field of the token").value(pep::commandline::Value<uint64_t>().defaultsTo(static_cast<uint64_t>(a_year_later), "a year from now"));
  }
  ...
  int execute() override {
    ...
    auto token = pep::OAuthToken::Generate(
      ...
      subject,
      group,
      values.get<uint64_t>("issued-at"),
      values.get<uint64_t>("expiration-time"));
