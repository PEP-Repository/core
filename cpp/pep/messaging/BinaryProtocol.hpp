...
public:
  static std::shared_ptr<networking::Protocol::ServerParameters> CreateServerParameters(boost::asio::io_context& context, uint16_t port, X509IdentityFiles identity);
