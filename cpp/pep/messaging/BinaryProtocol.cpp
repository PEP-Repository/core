...
#ifdef NO_TLS
  PEP_LOG(LOG_TAG, warning) << "Exposing server on port " << port << " over an unencrypted connection";
...
#ifdef NO_TLS
  PEP_LOG(LOG_TAG, warning) << "Connecting to " << endPoint.describe() << " over an unencrypted connection";
