...
#ifdef NO_TLS
  PEP_LOG(LogTag, warning) << "Exposing server on port " << port << " over an unencrypted connection";
...
#ifdef NO_TLS
  PEP_LOG(LogTag, warning) << "Connecting to " << endPoint.describe() << " over an unencrypted connection";
