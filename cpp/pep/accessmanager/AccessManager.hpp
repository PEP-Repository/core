...
public:
   ...
   */
  static std::vector<AmaQueryResponse> extractPartialColumnGroupQueryResponse(const std::vector<AmaQRColumnGroup>& columnGroups, const size_t maxSize = TLSMessageProtocol::MAX_SIZE_OF_MESSAGE);
