...
private:
  ...
  MessageBatches handleStructureMetadataRequest(std::shared_ptr<SignedStructureMetadataRequest> request);
  MessageBatches handleSetStructureMetadataRequest(std::shared_ptr<SignedSetStructureMetadataRequest> request, rxcpp::observable<std::shared_ptr<std::string>> chunks);
