...
AmaQueryResponse AccessManager::Backend::performAMAQuery(const AmaQuery& query, const std::string& userGroup) {
  ...
  UserGroup::EnsureAccess({ UserGroup::AccessAdministrator, UserGroup::DataAdministrator, UserGroup::DataOwner }, userGroup, "AmaQuery");
...
UserQueryResponse AccessManager::Backend::performUserQuery(const UserQuery& query, const std::string& userGroup) {
  UserGroup::EnsureAccess({ UserGroup::AccessAdministrator, UserGroup::DataOwner }, userGroup, "Querying users");
