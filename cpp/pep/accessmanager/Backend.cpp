...
void AccessManager::Backend::performUserMutationsForRequest(const UserMutationRequest& request, const std::string& userGroup) {
  // Check access
  ...
  for (auto& x : request.mRemoveUserFromGroup) {
    mStorage->removeUserFromGroup(x.mUid, x.mGroup);
