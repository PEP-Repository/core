...
private:
  ...
  /// Checks whether the database has been initialized. If the database has not been initialized, do so by hardcoded rules.
  ...
  /// Search for any access rules and group associations pertaining to tombstoned columns, columnGroups, or participantGroups, and remove them.
