...
AmaAddParticipantToGroup Serializer<AmaAddParticipantToGroup>::fromProtocolBuffer(proto::AmaAddParticipantToGroup&& source) const {
  return AmaAddParticipantToGroup(std::move(*source.mutable_group()), Serialization::FromProtocolBuffer(std::move(*source.mutable_participant())));
}
...
void Serializer<AmaAddParticipantToGroup>::moveIntoProtocolBuffer(proto::AmaAddParticipantToGroup& dest, AmaAddParticipantToGroup value) const {
  *dest.mutable_group() = std::move(value.mParticipantGroup);
  Serialization::MoveIntoProtocolBuffer(*dest.mutable_participant(), value.mParticipant);
}
...
AmaRemoveParticipantFromGroup Serializer<AmaRemoveParticipantFromGroup>::fromProtocolBuffer(proto::AmaRemoveParticipantFromGroup&& source) const {
  return AmaRemoveParticipantFromGroup(std::move(*source.mutable_group()), Serialization::FromProtocolBuffer(std::move(*source.mutable_participant())));
}
...
AmaMutationRequest Serializer<AmaMutationRequest>::fromProtocolBuffer(proto::AmaMutationRequest&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateColumn,
    std::move(*source.mutable_create_column()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveColumn,
    std::move(*source.mutable_remove_column()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateColumnGroup,
    std::move(*source.mutable_create_column_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveColumnGroup,
    std::move(*source.mutable_remove_column_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mAddColumnToGroup,
    std::move(*source.mutable_add_column_to_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveColumnFromGroup,
    std::move(*source.mutable_remove_column_from_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateParticipantGroup,
    std::move(*source.mutable_create_participant_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveParticipantGroup,
    std::move(*source.mutable_remove_participant_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mAddParticipantToGroup,
    std::move(*source.mutable_add_participant_to_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveParticipantFromGroup,
    std::move(*source.mutable_remove_participant_from_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateColumnGroupAccessRule,
    std::move(*source.mutable_create_column_group_access_rule()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveColumnGroupAccessRule,
    std::move(*source.mutable_remove_column_group_access_rule()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateParticipantGroupAccessRule,
    std::move(*source.mutable_create_participant_group_access_rule()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveParticipantGroupAccessRule,
...
void Serializer<AmaMutationRequest>::moveIntoProtocolBuffer(proto::AmaMutationRequest& dest, AmaMutationRequest value) const {
  ...
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_create_column(),
    std::move(value.mCreateColumn));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_column(),
    std::move(value.mRemoveColumn));
  Serialization::CopyToRepeatedProtocolBuffer(
  ...
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_create_participant_group(),
    std::move(value.mCreateParticipantGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_participant_group(),
    std::move(value.mRemoveParticipantGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_add_participant_to_group(),
    std::move(value.mAddParticipantToGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_participant_from_group(),
...
AmaQueryResponse Serializer<AmaQueryResponse>::fromProtocolBuffer(proto::AmaQueryResponse&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(result.mColumns,
    std::move(*source.mutable_columns()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mColumnGroups,
    std::move(*source.mutable_column_groups()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mColumnGroupAccessRules,
    std::move(*source.mutable_column_group_access_rules()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mParticipantGroups,
    std::move(*source.mutable_participant_groups()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mParticipantGroupAccessRules,
...
void Serializer<AmaQueryResponse>::moveIntoProtocolBuffer(proto::AmaQueryResponse& dest, AmaQueryResponse value) const {
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_columns(),
    std::move(value.mColumns));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_column_groups(),
