...
struct ColumnRecord {
  ...
  std::string name;
  static inline std::tuple RecordIdentifier{&ColumnRecord::name};
};
...
struct ColumnGroupRecord {
  ...
  std::string name;
  static inline std::tuple RecordIdentifier{&ColumnGroupRecord::name};
};
...
struct ColumnGroupColumnRecord {
  ...
  std::string columnGroup;
  std::string column;
  static inline std::tuple RecordIdentifier{
...
struct ParticipantGroupRecord {
  ...
  std::string name;
  static inline std::tuple RecordIdentifier{&ParticipantGroupRecord::name};
};
