...
void Serializer<CastorShortPseudonymDefinition>::moveIntoProtocolBuffer(proto::CastorShortPseudonymDefinition& dest, CastorShortPseudonymDefinition value) const {
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_storage(), value.getStorageDefinitions());
...
CastorShortPseudonymDefinition Serializer<CastorShortPseudonymDefinition>::fromProtocolBuffer(proto::CastorShortPseudonymDefinition&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(storage,
...
void Serializer<GlobalConfiguration>::moveIntoProtocolBuffer(proto::GlobalConfiguration& dest, GlobalConfiguration value) const {
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_short_pseudonyms(), value.getShortPseudonyms());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_additional_stickers(), value.getAdditionalStickers());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_participant_identifier_formats(), value.getParticipantIdentifierFormats());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_devices(), value.getDevices());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_column_specifications(), value.getColumnSpecifications());
  Serialization::MoveIntoProtocolBuffer(*dest.mutable_user_pseudonym_format(), value.getUserPseudonymFormat());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_assessors(), value.getAssessors());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_study_contexts(), value.getStudyContexts().getItems());
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_short_pseudonym_errata(), value.getShortPseudonymErrata());
}
...
GlobalConfiguration Serializer<GlobalConfiguration>::fromProtocolBuffer(proto::GlobalConfiguration&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(shortPseudonyms,
    std::move(*source.mutable_short_pseudonyms()));
  Serialization::CopyFromRepeatedProtocolBuffer(additionalStickers,
    std::move(*source.mutable_additional_stickers()));
  Serialization::CopyFromRepeatedProtocolBuffer(participantIdentifierFormats,
    std::move(*source.mutable_participant_identifier_formats()));
  Serialization::CopyFromRepeatedProtocolBuffer(devices,
    std::move(*source.mutable_devices()));
  Serialization::CopyFromRepeatedProtocolBuffer(assessors,
    std::move(*source.mutable_assessors()));
  Serialization::CopyFromRepeatedProtocolBuffer(studyContexts,
    std::move(*source.mutable_study_contexts()));
  Serialization::CopyFromRepeatedProtocolBuffer(columnSpecifications,
    std::move(*source.mutable_column_specifications()));
  Serialization::CopyFromRepeatedProtocolBuffer(spErrata,
