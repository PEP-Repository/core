...
const std::string SP_CHARS = "0123456789";

boost::random::random_device sp_rng;
boost::random::uniform_int_distribution<> sp_distribution = boost::random::uniform_int_distribution<>(
