...
typedef decltype(ParticipantDeviceRecord::time) StudyStartTimestamp;
...
protected:
  typedef std::unordered_map<std::string, std::shared_ptr<SurveyStep>> SurveyStepsById;
...
private:
  typedef std::unordered_map<std::string, Timestamp> StudyStartsByParticipantId;
