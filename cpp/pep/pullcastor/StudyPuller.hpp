...
private:
  typedef std::unordered_map<std::string, std::shared_ptr<Field>> FieldsById;
  typedef std::unordered_map<std::string, std::shared_ptr<RepeatingDataPuller>> RepeatingDataPullersById;
