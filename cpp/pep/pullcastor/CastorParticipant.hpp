...
public:
  ...
  /*!
    ...
    */
  inline std::shared_ptr<Participant> getParticipant() const noexcept { return participant_; }
  ...
  /*!
    ...
    */
  inline rxcpp::observable<std::shared_ptr<RepeatingDataInstance>> getRepeatingDataInstances() { return repeatingDataInstances_->observe(); }
