...
#  define BUILD_PIPELINE 0
#else
#  define BUILD_PIPELINE BUILD_PIPELINE_ID
#endif

#if BOOST_PP_IS_EMPTY(BUILD_JOB_ID)
#  define BUILD_JOB 0
#else 
#  define BUILD_JOB BUILD_JOB_ID
#endif
...
#pragma message("BinaryVersion::PipelineId() = " BOOST_PP_STRINGIZE(BUILD_PIPELINE))
#pragma message("BinaryVersion::JobId() = " BOOST_PP_STRINGIZE(BUILD_JOB))
...
const BinaryVersion BinaryVersion::current(BUILD_PROJECT_PATH, BUILD_REF, BUILD_REV, BUILD_MAJOR_VERSION, BUILD_MINOR_VERSION, BUILD_PIPELINE, BUILD_JOB,  BUILD_TARGET, GetCurrentProtocolChecksum());
