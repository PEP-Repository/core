...
namespace {
  ...
  TEST(S3, AH_get_unreserved) {
    ...
    "GET", url("/-._~0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"), "", {
  ...
  TEST(S3, AH_get_vanilla_empty_query_order_key_case) {
    HttpRequest r("example.amazonaws.com",
        "GET", url("/?Param2=value2&Param1=value1"), "", {
          {"Host", "example.amazonaws.com"},
          {"X-Amz-Date", "20150830T123600Z"}
        }, false);
  ...
  TEST(S3, AH_get_vanilla_query_unreserved) {
    HttpRequest r("example.amazonaws.com",
        "GET", url("/?-._~0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz=-._~0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"), "", {
          {"Host", "example.amazonaws.com"},
          {"X-Amz-Date", "20150830T123600Z"}
        }, false);
  ...
  TEST(S3, AH_get_vanilla_utf8_query) {
    HttpRequest r("example.amazonaws.com",
        "GET", url("/").set_query("\xe1\x88\xb4=bar"), "", {
          {"Host", "example.amazonaws.com"},
          {"X-Amz-Date", "20150830T123600Z"}
        }, false);
