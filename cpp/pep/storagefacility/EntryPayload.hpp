...
public:
  ...
  virtual rxcpp::observable<std::shared_ptr<std::string>> readPage(std::shared_ptr<PageStore> pageStore, const EntryName& name, size_t index) const = 0;
...
public:
  ...
  rxcpp::observable<std::shared_ptr<std::string>> readPage(std::shared_ptr<PageStore> pageStore, const EntryName& name, size_t index) const override;
