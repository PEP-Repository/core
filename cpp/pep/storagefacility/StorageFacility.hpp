...
private:
  MessageBatches handleDataEnumerationRequest2(std::shared_ptr<SignedDataEnumerationRequest2> request);
  MessageBatches handleDataStoreRequest2(std::shared_ptr<SignedDataStoreRequest2> lpRequest, MessageSequence tail);
  MessageBatches handleMetadataStoreRequest2(std::shared_ptr<SignedMetadataUpdateRequest2> lpRequest);
  MessageBatches handleMetadataReadRequest2(std::shared_ptr<SignedMetadataReadRequest2> lpRequest);
  MessageBatches handleDataReadRequest2(std::shared_ptr<SignedDataReadRequest2> lpRequest);
  MessageBatches handleDataDeleteRequest2(std::shared_ptr<SignedDataDeleteRequest2> lpRequest);
  MessageBatches handleDataHistoryRequest2(std::shared_ptr<SignedDataHistoryRequest2> lpRequest);
  ...
  MessageBatches handleDataAlterationRequest(
  ...
  void emitPage(rxcpp::subscriber<MessageSequence> subscriber, uint32_t fileIndex, uint32_t pageIndex, MessageSequence page) const;
