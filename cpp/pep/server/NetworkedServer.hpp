...
/// A pep::Server that accepts network connections using its own I/O context.
...
public:
  ...
  /// Stops (the I/O context associated with) the server, causing it to no longer accept incoming network connections or requests.
  void stop();
};
