...
PtreeAccess<boost::property_tree::ptree>::ReturnType PtreeAccess<boost::property_tree::ptree>::Get(const boost::property_tree::ptree& parent, const std::string& path) {
  try {
...
PtreeAccess<boost::optional<boost::property_tree::ptree>>::ReturnType PtreeAccess<boost::optional<boost::property_tree::ptree>>::Get(const boost::property_tree::ptree& parent, const std::string& path) {
