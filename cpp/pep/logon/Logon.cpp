...
private:
  ...
  int execute() override {
    ...
    mConfig = this->loadMainConfigFile(this->getParameterValues().get<std::filesystem::path>("config"));
...
protected:
  ...
  pep::commandline::Parameters getSupportedParameters() const override {
    return pep::commandline::Utility::getSupportedParameters()
      + pep::commandline::Parameter("config", "Path to configuration file").value(pep::commandline::Value<std::filesystem::path>().positional()
