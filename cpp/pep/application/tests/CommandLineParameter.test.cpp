...
int Process(AppCmd&& cmd, std::initializer_list<std::string> args) {
  return Process(cmd, args); // passing rvalue arg as lvalue
}
...
std::vector<std::shared_ptr<pep::commandline::Command>> AppCmd::createChildCommands() {
  ...
  return {
    ...
    pep::commandline::CreateAliasCommand(*this, "create-user-email", *this, {"user"}, forwardToUserParam("email")),
    pep::commandline::CreateAliasCommand(*this, "create-user-old-email", *this, {"user"}, forwardToUserParam("old-email")),
    pep::commandline::CreateAliasCommand(*this, "create-user-mail", *this, {"user"}, forwardToUserParam("mail")),
    pep::commandline::CreateAliasCommand(*this, "create-user-fwd-username", *this, {"user"}, forwardToUserParam("forward-username")),
    pep::commandline::CreateAliasCommand(*this, "create-user-removed-role", *this, {"user"}, forwardToUserParam("removed-role")),
