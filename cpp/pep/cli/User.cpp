...
std::vector<std::shared_ptr<pep::commandline::Command>> CommandUser::createChildCommands() {
  return {
    ...
    std::make_shared<UserSubCommand>("setDisplayId", "Set the display identifier for user", &pep::CoreClient::setUserDisplayId, *this),
    std::make_shared<UserSubCommand>("setPrimaryId", "Set the primary identifier for user", &pep::CoreClient::setUserPrimaryId, *this),
    std::make_shared<UserSubCommand>("unsetPrimaryId", "Set the primary identifier for user", &pep::CoreClient::unsetUserPrimaryId, *this),
