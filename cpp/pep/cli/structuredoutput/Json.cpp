...
std::ostream& append(std::ostream& stream, const pep::AsaQRUserGroup& group, int indentLevel) {
  const auto ind = [&indentLevel]() { return indentations(indentLevel); };
  const auto maxAuth = group.mProperties.mMaxAuthValidity;
...
std::ostream& append(std::ostream& stream, const pep::AsaQRUser& user, DisplayConfig config) {
...
std::ostream& append(std::ostream& stream, const std::vector<pep::AsaQRUserGroup>& groups, DisplayConfig config) {
  const auto ind = [&config]() { return indentations(config.indent); };
...
std::ostream& append(std::ostream& stream, const std::vector<pep::AsaQRUser>& users, DisplayConfig config) {
  const auto ind = [&config]() { return indentations(config.indent); };
  const auto includeHeader = config.flags & DisplayConfig::Flags::printHeaders;
...
std::ostream& append(std::ostream& stream, const pep::AsaQueryResponse& response, DisplayConfig config) {
  const auto ind = [&config]() { return indentations(config.indent); };
