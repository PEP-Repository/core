...
std::ostream& appendYaml(std::ostream& stream,
                         const std::vector<pep::AsaQRUserGroup>& group,
  ...
  for (auto& g : group) {
    const auto& gMaxAuth = g.mProperties.mMaxAuthValidity;
...
std::ostream& appendYaml(std::ostream& stream,
                         const std::vector<pep::AsaQRUser>& users,
                         const DisplayFlags::T& flags) {
...
std::ostream& append(std::ostream& stream, const pep::AsaQueryResponse& res, DisplayConfig config) {
