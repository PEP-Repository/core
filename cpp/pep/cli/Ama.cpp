        ...
        .map([scriptPrintFilter](pep::AmaQueryResponse res) {
          ...
          if (scriptPrintFilter.empty() || scriptPrintFilter == "participant-group-access-rules") {
            ...
            std::cerr
              ...
              << pep::user_group::DataAdministrator << " has implicit full access to all participant groups." << '\n'
              << pep::user_group::DataAdministrator << " has implicit \"read-meta\" access to all column groups." << std::endl;
          }
