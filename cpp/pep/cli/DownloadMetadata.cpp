...
pep::ElgamalEncryption PropertySerializer<pep::ElgamalEncryption>::read(const boost::property_tree::ptree& source, const MultiTypeTransform& transform) const {
  return pep::ElgamalEncryption::FromText(DeserializeProperties<std::string>(source, transform));
}

void PropertySerializer<pep::ElgamalEncryption>::write(boost::property_tree::ptree& destination, const pep::ElgamalEncryption& value) const {
  SerializeProperties(destination, value.text());
}

pep::Timestamp PropertySerializer<pep::Timestamp>::read(const boost::property_tree::ptree& source, const MultiTypeTransform& transform) const {
  return pep::Timestamp(DeserializeProperties<int64_t>(source, transform));
}

void PropertySerializer<pep::Timestamp>::write(boost::property_tree::ptree& destination, const pep::Timestamp& value) const {
  SerializeProperties(destination, value.getTime());
}

ParticipantIdentifier PropertySerializer<pep::ParticipantIdentifier>::read(const boost::property_tree::ptree& source, const MultiTypeTransform& transform) const {
  auto polymorphic = DeserializeProperties<pep::PolymorphicPseudonym>(source, "polymorphic", transform);
  auto local = DeserializeProperties<pep::LocalPseudonym>(source, "local", transform);
  return pep::ParticipantIdentifier(polymorphic, local);
}

void PropertySerializer<pep::ParticipantIdentifier>::write(boost::property_tree::ptree& destination, const pep::ParticipantIdentifier& value) const {
...
RecordDescriptor PropertySerializer<RecordDescriptor>::read(const boost::property_tree::ptree& source, const MultiTypeTransform& transform) const {
  auto participant = DeserializeProperties<pep::ParticipantIdentifier>(source, "participant", transform);
  auto column = DeserializeProperties<std::string>(source, "column", transform);
  auto blindingTimestamp = DeserializeProperties<pep::Timestamp>(source, "timestamp", transform); // Not named "blinding-timestamp" or the likes to keep key name backward compatible
  auto payloadBlindingTimestamp = DeserializeProperties<std::optional<pep::Timestamp>>(source, "payload-blinding-timestamp", transform);
  return RecordDescriptor(participant, column, blindingTimestamp, payloadBlindingTimestamp);
}

void PropertySerializer<RecordDescriptor>::write(boost::property_tree::ptree& destination, const RecordDescriptor& value) const {
...
RecordState PropertySerializer<RecordState>::read(const boost::property_tree::ptree& source, const MultiTypeTransform& transform) const {
  auto descriptor = DeserializeProperties<RecordDescriptor>(source, "descriptor", transform);
  auto hash = DeserializeProperties<std::optional<pep::XxHasher::Hash>>(source, "hash", transform);
  return RecordState{ descriptor, hash };
}

void PropertySerializer<RecordState>::write(boost::property_tree::ptree& destination, const RecordState& value) const {
