...
class ServerPinger {
public:
  virtual inline ~ServerPinger() noexcept {}
...
public:
  typedef rxcpp::observable<TResponse>(TClient::*SendMethod)() const;
...
typedef SigningServerPinger<pep::CoreClient, &pep::CoreClient::pingAccessManager> AccessManagerPinger;
typedef SigningServerPinger<pep::CoreClient, &pep::CoreClient::pingStorageFacility> StorageFacilityPinger;
typedef SigningServerPinger<pep::CoreClient, &pep::CoreClient::pingTranscryptor> TranscryptorPinger;
typedef SigningServerPinger<pep::Client, &pep::Client::pingAuthserver> AuthServerPinger;
typedef SigningServerPinger<pep::Client, &pep::Client::pingRegistrationServer> RegistrationServerPinger;
...
typedef std::shared_ptr<ServerPinger> (*ServerPingerFactoryMethod)(bool printCertificateChain, bool printDrift);
