...
TEST_F(RskTranslatorTest, ReshuffleRekeyProofVerifiers) {
  ...
  const ReshuffleRekeyVerifiers expectedVerifiers(
      ...
      point({0xB4, 0x15, 0xC3, 0x74, 0x97, 0x1C, 0x0A, 0x49,
             0xF7, 0x3D, 0x3C, 0xCC, 0x10, 0xA7, 0x13, 0x0E,
             0x85, 0x68, 0xF9, 0xA7, 0xA6, 0x2C, 0x71, 0xD7,
             0x75, 0x3F, 0x4E, 0x52, 0x47, 0xC4, 0x46, 0x4B}),
