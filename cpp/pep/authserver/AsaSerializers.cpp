...
AsaMutationRequest Serializer<AsaMutationRequest>::fromProtocolBuffer(proto::AsaMutationRequest&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateUser,
    std::move(*source.mutable_create_user()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveUser,
    std::move(*source.mutable_remove_user()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mAddUserIdentifier,
    std::move(*source.mutable_add_user_identifier()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveUserIdentifier,
    std::move(*source.mutable_remove_user_identifier()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mCreateUserGroup,
    std::move(*source.mutable_create_user_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveUserGroup,
    std::move(*source.mutable_remove_user_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mModifyUserGroup,
    std::move(*source.mutable_modify_user_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mAddUserToGroup,
    std::move(*source.mutable_add_user_to_group()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mRemoveUserFromGroup,
...
void Serializer<AsaMutationRequest>::moveIntoProtocolBuffer(proto::AsaMutationRequest& dest, AsaMutationRequest value) const {
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_create_user(),
    std::move(value.mCreateUser));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_user(),
    std::move(value.mRemoveUser));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_add_user_identifier(),
    std::move(value.mAddUserIdentifier));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_user_identifier(),
    std::move(value.mRemoveUserIdentifier));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_create_user_group(),
    std::move(value.mCreateUserGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_user_group(),
    std::move(value.mRemoveUserGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_modify_user_group(),
    std::move(value.mModifyUserGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_add_user_to_group(),
    std::move(value.mAddUserToGroup));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_remove_user_from_group(),
...
AsaQueryResponse Serializer<AsaQueryResponse>::fromProtocolBuffer(proto::AsaQueryResponse&& source) const {
  ...
  Serialization::CopyFromRepeatedProtocolBuffer(result.mUsers,
    std::move(*source.mutable_users()));
  Serialization::CopyFromRepeatedProtocolBuffer(result.mUserGroups,
...
void Serializer<AsaQueryResponse>::moveIntoProtocolBuffer(proto::AsaQueryResponse& dest, AsaQueryResponse value) const {
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_users(),
    std::move(value.mUsers));
  Serialization::CopyToRepeatedProtocolBuffer(*dest.mutable_user_groups(),
