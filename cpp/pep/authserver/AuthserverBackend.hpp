...
public:
  ...
  public:
    ...
    const std::shared_ptr<TLSMessageProtocol::Connection> getAccessManager() const;
    void setAccessManager(std::shared_ptr<TLSMessageProtocol::Connection> accessManager);
...
private:
  ...
  std::shared_ptr<TLSMessageProtocol::Connection> mAccessManager;
