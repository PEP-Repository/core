...
public:
  ...
  enum class ConnectivityStatus {
    unconnected   = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::uninitialized),
    reconnecting  = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::reinitializing),
    connecting    = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::initializing),
    connected     = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::initialized),
    disconnecting = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::finalizing),
    disconnected  = static_cast<std::underlying_type_t<LifeCycler::Status>>(LifeCycler::Status::finalized)
  };
  ...
  /*
   * \brief Asynchronously reads a data from the Transport until specified data is received
