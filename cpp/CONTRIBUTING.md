...
We encourage using links to related core guideliness sections in code reviews. This helps keeping review comments concise and saves you from having to explain the same thing in multiple reviews.
...
# PEP C++ Guidelines
This section lists our own coding guideliness, which we apply on top of the more generic [core guidelines](#cpp-core-guidelines).
...
- When operations contain multiple lambda's, start each lambda with a line of comment introducing it's purpose.
...
<details>
  <summary>Current list of libraries</summary> 

  (as used in _production_, not during development like a testing framework):
  - boost
  - protobuf
  - mbedtls
  - prometheus-cpp
  ...
  As our dependencies are managed through Conan, have a look at [conanfile.py](/conanfile.py) too.
</details>
