...
When working on MS-Windows, you'll probably want to develop using Microsoft Visual Studio. This page describes how to get such a dev box set up. There is also a page describing how to set up a [Windows runner for gitlab CI jobs](windows-build-machine.md).
