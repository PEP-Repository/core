...
# Assumed to be ran in a folder with the app and cli subdirectories, each containing their corresponding .app bundles
...
sign_app() {
  ...
  local codesign_options=(-v -f --options=runtime --timestamp -s)
  ...
  codesign -v -f --timestamp -s "$GITLAB_CI_MACOS_CERTIFICATE_APP_NAME" "$app_path/Contents/Frameworks/Sparkle.framework"
  ...
  codesign -v --deep --timestamp -s "$GITLAB_CI_MACOS_CERTIFICATE_APP_NAME" "$app_path" || true
...
# Update versions
PEP_MACOS_ASS_APP_VERSION="1.1.${CI_PIPELINE_ID:-$PEP_MACOS_DEFAULT_VERSION}"
set_or_add_plist "$PEP_MACOS_ASS_APP_PLIST_PATH" "CFBundleVersion" "string" "$PEP_MACOS_ASS_APP_VERSION"
set_or_add_plist "$PEP_MACOS_ASS_APP_PLIST_PATH" "CFBundleShortVersionString" "string" "$PEP_MACOS_ASS_APP_VERSION"

PEP_MACOS_CLI_APP_VERSION="1.1.${CI_PIPELINE_ID:-$PEP_MACOS_DEFAULT_VERSION}"
set_or_add_plist "$PEP_MACOS_CLI_APP_PLIST_PATH" "CFBundleVersion" "string" "$PEP_MACOS_CLI_APP_VERSION"
set_or_add_plist "$PEP_MACOS_CLI_APP_PLIST_PATH" "CFBundleShortVersionString" "string" "$PEP_MACOS_CLI_APP_VERSION"
...
# Sign PEP Assessor app, create pkg
create_app "$PEP_MACOS_ASS_APP_ROOT" "$PEP_MACOS_ASS_APP_INFRA_NAME" "$PEP_MACOS_ASS_APP_INSTALL_LOCATION" "$PEP_MACOS_ASS_APP_VERSION" "$PEP_MACOS_ASS_APP_IDENTIFIER"

# Sign PEP Command Line Interface app, create pkg
create_app "$PEP_MACOS_CLI_APP_ROOT" "$PEP_MACOS_CLI_APP_INFRA_NAME" "$PEP_MACOS_CLI_APP_INSTALL_LOCATION" "$PEP_MACOS_CLI_APP_VERSION" "$PEP_MACOS_CLI_APP_IDENTIFIER"
...
<installer-gui-script minSpecVersion="1">
    ...
    <choice id="pepassessor" title="$PEP_MACOS_ASS_APP_NAME" description="$PEP_MACOS_ASS_APP_NAME">
        <pkg-ref id="$PEP_MACOS_ASS_APP_IDENTIFIER" version="$PEP_MACOS_ASS_APP_VERSION" onConclusion="none">$PEP_MACOS_ASS_APP_INFRA_NAME.pkg</pkg-ref>
    </choice>
    <choice id="pepcli" title="$PEP_MACOS_CLI_APP_NAME" description="$PEP_MACOS_CLI_APP_NAME">
        <pkg-ref id="$PEP_MACOS_CLI_APP_IDENTIFIER" version="$PEP_MACOS_CLI_APP_VERSION" onConclusion="none">$PEP_MACOS_CLI_APP_INFRA_NAME.pkg</pkg-ref>
    </choice>
