...
echo "  2. Then, to enter the container which includes pepcli, run: docker exec -it pep-tutorial bash"
echo "  3. Inside the container, run: pepLogon"
echo "  4. Then use pepcli commands as shown in the tutorial documentation"
echo ""
echo "To stop the container, run: docker stop pep-tutorial"
echo "================================================================"
echo ""
