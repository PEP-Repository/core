...
create_cli_app() {
    ...
    (
        ...
        "$PEP_MACOS_ROOT_DIR/installer/macOS/create-info-plist.sh" "$info_plist_type"
    )
}
...
PEP_MACOS_DT_APP_NAME="PEP Download Tool"
PEP_MACOS_DT_APP_BUILD_ROOT_DIR="$PEP_MACOS_ROOT_DIR/$BUILD_DIR/macOS_artifacts/dt/$PEP_MACOS_DT_APP_NAME.app"

create_cli_app \
    "$PEP_MACOS_DT_APP_NAME" \
    "$PEP_MACOS_DT_APP_BUILD_ROOT_DIR" \
