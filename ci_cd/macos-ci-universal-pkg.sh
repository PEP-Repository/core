...
"$PEP_MACOS_FOSS_DIR/installer/macOS/create-universal-binary.sh"
...
"$PEP_MACOS_FOSS_DIR/installer/macOS/create-macos-installer.sh" "Universal" "$PROJECT_CAPTION" "$CI_COMMIT_REF_NAME" 
